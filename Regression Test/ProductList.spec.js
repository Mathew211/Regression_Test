...
const { ProducList } = require('../PageObject/Pages/ProductList');
...
test.describe('Productlsit : ', () => {
    ...
    //     listing = new ProducList(page)
    //     await listing.chooseYourFilters();
...
//     test('Wishlist with one item ', async ({ page }) => {
...
//     test('Add more items to wishlist ', async ({ page }) => {
...
test.describe('Comparison tools  : ', () => {
    ...
    // test('When compare is not possible ', async ({ page }) => {
    ...
    // test('Comparing is active ', async ({ page }) => {
    ...
    test('Moving between the gropus ', async ({ page }) => {
    ...
    // test('Cancel remove button', async ({ page }) => {
    ...
    // test('Confirm remove  button ', async ({ page }) => {
